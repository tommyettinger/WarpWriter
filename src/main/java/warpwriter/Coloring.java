...
//            0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    ...
    /**
     * The same colors as {@link #RINSED}, but organized so the colors from index 16 to index 255 inclusive are sorted
     * by hue, from red to orange to yellow to green to blue to purple, while still being organized in blocks of 8
     * colors at a time from bright to dark. Some almost-grayscale blocks are jumbled in the middle, but they do have a
     * hue and it is always at the point where they are in the sort. If you generate colors using these indices, then
     * you can still render using a PaletteReducer that reduces to the colors in {@link #RINSED}, though possibly with
     * some loss of variety on very similar colors. You could also have a PaletteReducer that uses {@link #RINSED} and
     * call its lookup() method to get the right byte index into RINSED for a color from this array.
     */
    public static final int[] RINSED_BY_HUE = {
            0x00000000, 0x444444ff, 0x000000ff, 0x88ffff00, 0x212121ff, 0x00ff00ff, 0x0000ffff, 0x080808ff,
            0xff574600, 0xffb14600, 0xfffd4600, 0x4bff4600, 0x51bf6c00, 0x4697ff00, 0x9146ff00, 0xff46ae00,
            0xd89789ff, 0xc4877aff, 0xb47b76ff, 0xa36c72ff, 0x905861ff, 0x76454cff, 0x5f3234ff, 0x452327ff,
            0xf9dcb8ff, 0xceb29aff, 0xb29891ff, 0x8f797fff, 0x75636fff, 0x554b67ff, 0x3e3552ff, 0x272340ff,
