...
//        }
    ...
    public static final int[] CurveballBonusPalette = new int[256];
    public static final byte[][] CURVEBALL_RAMPS = new byte[][]{
            { 0, 0, 0, 0 },
            { 29, 39, 1, 63 },
            { 23, 14, 2, 1 },
            { 31, 39, 3, 59 },
    ...
    int[][] CURVEBALL_RAMP_VALUES = new int[][]{
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0xF16F9BFF, 0x9C9C9CFF, 0xF1D5B0FF, 0xFFFFFFFF },
            { 0x5E5E5EFF, 0xEC9E38FF, 0xF9C969FF, 0xF1D5B0FF },
            { 0x7F7F7FFF, 0x9C9C9CFF, 0xA4CE87FF, 0xCFE996FF },
            { 0x6FE0C1FF, 0x89E3CEFF, 0xAFF8EFFF, 0xFFFFFFFF },
            { 0x3D3D3DFF, 0x106AD4FF, 0x1DAA9DFF, 0x3AD6D9FF },
            { 0x106AD4FF, 0x1DAA9DFF, 0x10D6DBFF, 0x68F6E5FF },
            { 0xF1D5B0FF, 0xF1D5B0FF, 0x1C1C1CFF, 0x3D3D3DFF },
            { 0x1C1C1CFF, 0x5229EEFF, 0x106AD4FF, 0x3DA1C7FF },
            { 0x106AD4FF, 0x3DA1C7FF, 0x7FA8F8FF, 0xC8ADF2FF },
            { 0xF1D5B0FF, 0x1C1C1CFF, 0x5229EEFF, 0xA11BFDFF },
            { 0x106AD4FF, 0x3DA1C7FF, 0x79A2F9FF, 0xC8ADF2FF },
            { 0x1C1C1CFF, 0x5229EEFF, 0xA11BFDFF, 0xBD63FFFF },
            { 0xBA37D9FF, 0xCF48CCFF, 0xD486F3FF, 0xDEDEDEFF },
            { 0x3D3D3DFF, 0x5E5E5EFF, 0xEC9E38FF, 0xFAC05AFF },
            { 0xF1D5B0FF, 0x1C1C1CFF, 0x3D3D3DFF, 0x5E5E5EFF },
            { 0x6DABEFFF, 0x6FE0C1FF, 0x9CFEE7FF, 0xFFFFFFFF },
            { 0x3AD6D9FF, 0x51C7EEFF, 0x81ECD7FF, 0xFFFFFFFF },
            { 0x1DAA9DFF, 0x3DA1C7FF, 0x3AD6D9FF, 0x68F6E5FF },
            { 0x106AD4FF, 0x1DAA9DFF, 0x26E0D3FF, 0x68F6E5FF },
            { 0x839FDAFF, 0x6FE0C1FF, 0xB1EDEDFF, 0xFFFFFFFF },
            { 0x3D3D3DFF, 0x5E5E5EFF, 0x7895CAFF, 0xC8ADF2FF },
            { 0x106AD4FF, 0x3DA1C7FF, 0x879AFCFF, 0xC8ADF2FF },
            { 0x1C1C1CFF, 0x3D3D3DFF, 0x5E5E5EFF, 0x7F7F7FFF },
            { 0xAF68B1FF, 0xBD63FFFF, 0xC5A3EAFF, 0xDEDEDEFF },
            { 0x1C1C1CFF, 0x5229EEFF, 0xBD15FFFF, 0xBD63FFFF },
            { 0xBB44ACFF, 0xAF68B1FF, 0xFB8DBBFF, 0xF1D5B0FF },
            { 0xF1D5B0FF, 0x1C1C1CFF, 0xB91DB1FF, 0xCF48CCFF },
            { 0x3D3D3DFF, 0xB91DB1FF, 0xCF48CCFF, 0xDF6AEEFF },
            { 0xB91DB1FF, 0xBB44ACFF, 0xF16F9BFF, 0xF1D5B0FF },
            { 0x7F7F7FFF, 0x9C9C9CFF, 0xC9D88DFF, 0xDEDEDEFF },
            { 0x3D3D3DFF, 0x5E5E5EFF, 0x7F7F7FFF, 0x9C9C9CFF },
            { 0x7F7F7FFF, 0x9C9C9CFF, 0xBCDD8EFF, 0xDEDEDEFF },
            { 0x7895CAFF, 0x839FDAFF, 0x89E3CEFF, 0xAFF8EFFF },
            { 0x1DAA9DFF, 0x3DA1C7FF, 0x51C7EEFF, 0x68F6E5FF },
            { 0x106AD4FF, 0x3DA1C7FF, 0x7AAAF2FF, 0x81ECD7FF },
            { 0x5E5E5EFF, 0x3DA1C7FF, 0x839FDAFF, 0xC8ADF2FF },
            { 0x5E5E5EFF, 0x7F7F7FFF, 0xA3A0DEFF, 0xB1EDEDFF },
            { 0xBA37D9FF, 0xBD63FFFF, 0xBF93F8FF, 0xDEDEDEFF },
            { 0x5E5E5EFF, 0x7F7F7FFF, 0x9C9C9CFF, 0xBDBDBDFF },
            { 0x1C1C1CFF, 0x3D3D3DFF, 0xBB44ACFF, 0xDF6AEEFF },
            { 0xBA37D9FF, 0xCF48CCFF, 0xDF6AEEFF, 0xC8ADF2FF },
            { 0xB91DB1FF, 0xBA37D9FF, 0xFD47F9FF, 0xD486F3FF },
            { 0x7F7F7FFF, 0x76CA7CFF, 0xB7E88FFF, 0xDEDEDEFF },
            { 0x9C9C9CFF, 0x76CA7CFF, 0x9FE0B2FF, 0xAFF8EFFF },
            { 0x3DA1C7FF, 0x3AD6D9FF, 0x68F6E5FF, 0xAFF8EFFF },
            { 0x3DA1C7FF, 0x6DABEFFF, 0x6FE0C1FF, 0x9CFEE7FF },
            { 0x7F7F7FFF, 0x9C9C9CFF, 0xBDBDBDFF, 0xDEDEDEFF },
            { 0x3DA1C7FF, 0x3AD6D9FF, 0x70FCCEFF, 0xAFF8EFFF },
            { 0x3D3D3DFF, 0x106AD4FF, 0x3DA1C7FF, 0x6DABEFFF },
            { 0x106AD4FF, 0x3DA1C7FF, 0x6DABEFFF, 0x81ECD7FF },
            { 0x7895CAFF, 0x839FDAFF, 0xC8ADF2FF, 0xDEDEDEFF },
            { 0xA11BFDFF, 0xBA37D9FF, 0xBD63FFFF, 0xBF93F8FF },
            { 0x1C1C1CFF, 0x3D3D3DFF, 0xBA37D9FF, 0xBD63FFFF },
            { 0x3D3D3DFF, 0xB91DB1FF, 0xAF68B1FF, 0xDF6AEEFF },
            { 0x9C9C9CFF, 0xBDBDBDFF, 0xDEDEDEFF, 0xFFFFFFFF },
            { 0xB91DB1FF, 0xBA37D9FF, 0xF345DEFF, 0xD486F3FF },
            { 0xF16F9BFF, 0x9C9C9CFF, 0xE1B29BFF, 0xDEDEDEFF },
            { 0x5E5E5EFF, 0xEC9E38FF, 0xFAC05AFF, 0xF1D5B0FF },
            { 0x9C9C9CFF, 0xA4CE87FF, 0xCFE996FF, 0xFFFFFFFF },
            { 0x7F7F7FFF, 0x76CA7CFF, 0xA0F18DFF, 0xA9EFD9FF },
            { 0x5E5E5EFF, 0x7F7F7FFF, 0x76CA7CFF, 0x9FE0B2FF },
            { 0x839FDAFF, 0x6FE0C1FF, 0xA9EFD9FF, 0xFFFFFFFF },
            { 0xBDBDBDFF, 0xDEDEDEFF, 0xFFFFFFFF, 0x7FA8F8FF },
    };

    private static final int[][] CURVEBALL_BONUS_RAMP_VALUES = new int[][]{
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x988264FF, 0xD0AF83FF, 0xF1D5B0FF, 0xFFF9E3FF },
            { 0xA68033FF, 0xE9AF3CFF, 0xF9C969FF, 0xF9DCA2FF },
            { 0x63854CFF, 0x84B762FF, 0xA4CE87FF, 0xC2DCB2FF },
            { 0x5F9992FF, 0x78D0C5FF, 0xAFF8EFFF, 0xF0FFFFFF },
            { 0x006E64FF, 0x009989FF, 0x1DAA9DFF, 0x5FB3ABFF },
            { 0x008A8DFF, 0x00BEC4FF, 0x10D6DBFF, 0x6EE5E7FF },
            { 0x101010FF, 0x161616FF, 0x1C1C1CFF, 0x212121FF },
            { 0x00398EFF, 0x0048C7FF, 0x106AD4FF, 0x5B91D1FF },
            { 0x3E5E9FFF, 0x4A7ADBFF, 0x7FA8F8FF, 0xC3DBFFFF },
            { 0x2403A0FF, 0x2700E2FF, 0x5229EEFF, 0x8B73E9FF },
            { 0x3A5BA0FF, 0x4375DCFF, 0x79A2F9FF, 0xBED7FFFF },
            { 0x5E00A8FF, 0x7C00EAFF, 0xA11BFDFF, 0xC979FFFF },
            { 0x804199FF, 0xAC4ED0FF, 0xD486F3FF, 0xFDCEFFFF },
            { 0xA36513FF, 0xE98B10FF, 0xEC9E38FF, 0xDAAB6DFF },
            { 0x242424FF, 0x303030FF, 0x3D3D3DFF, 0x494949FF },
            { 0x519F8DFF, 0x64D9BEFF, 0x9CFEE7FF, 0xE0FFFFFF },
            { 0x3F9584FF, 0x4BCCB2FF, 0x81ECD7FF, 0xC5FFF8FF },
            { 0x0B888AFF, 0x00BABEFF, 0x3AD6D9FF, 0x8DEAECFF },
            { 0x009186FF, 0x00C8B8FF, 0x26E0D3FF, 0x7DEDE5FF },
            { 0x619191FF, 0x7BC3C4FF, 0xB1EDEDFF, 0xEFFFFFFF },
            { 0x3E5580FF, 0x4C70AFFF, 0x7895CAFF, 0xADBEDEFF },
            { 0x4453A2FF, 0x5369E0FF, 0x879AFCFF, 0xC8D3FFFF },
            { 0x383838FF, 0x4B4B4BFF, 0x5E5E5EFF, 0x717171FF },
            { 0x745992FF, 0x9971C6FF, 0xC5A3EAFF, 0xF2DEFFFF },
            { 0x7300A8FF, 0x9A00EAFF, 0xBD15FFFF, 0xDD79FFFF },
            { 0xA34A6FFF, 0xE15D94FF, 0xFB8DBBFF, 0xFFC8E4FF },
            { 0x770071FF, 0xA5009BFF, 0xB91DB1FF, 0xC467BFFF },
            { 0x831781FF, 0xB412B0FF, 0xCF48CCFF, 0xE392E1FF },
            { 0xA0385BFF, 0xDF4378FF, 0xF16F9BFF, 0xF4A6C1FF },
            { 0x7E8A4EFF, 0xACBD63FF, 0xC9D88DFF, 0xE2EBBEFF },
            { 0x4C4C4CFF, 0x656565FF, 0x7F7F7FFF, 0x989898FF },
            { 0x748E4FFF, 0x9DC365FF, 0xBCDD8EFF, 0xD9EDBEFF },
            { 0x468F7EFF, 0x56C3AAFF, 0x89E3CEFF, 0xC6FDF0FF },
            { 0x1B7998FF, 0x15A3D2FF, 0x51C7EEFF, 0xA2E9FFFF },
            { 0x3B619BFF, 0x457FD5FF, 0x7AAAF2FF, 0xBEDBFFFF },
            { 0x445B8AFF, 0x5476BDFF, 0x839FDAFF, 0xBBCCF0FF },
            { 0x5C598BFF, 0x7673BEFF, 0xA3A0DEFF, 0xD5D3F8FF },
            { 0x6F4C9DFF, 0x915DD7FF, 0xBF93F8FF, 0xF0D6FFFF },
            { 0x5D5D5DFF, 0x7D7D7DFF, 0x9C9C9CFF, 0xBBBBBBFF },
            { 0x78186BFF, 0xA51592FF, 0xBB44ACFF, 0xCA83C1FF },
            { 0x8A2D96FF, 0xBB2FCDFF, 0xDF6AEEFF, 0xFFB9FFFF },
            { 0xA1109EFF, 0xDD03D8FF, 0xFD47F9FF, 0xFFA6FFFF },
            { 0x6F964FFF, 0x96D066FF, 0xB7E88FFF, 0xD8F5C0FF },
            { 0x5A8E69FF, 0x75C38BFF, 0x9FE0B2FF, 0xCEF5DAFF },
            { 0x2B9C8FFF, 0x2CD7C2FF, 0x68F6E5FF, 0xB8FFFFFF },
            { 0x358F76FF, 0x3DC4A0FF, 0x6FE0C1FF, 0xAFF3E0FF },
            { 0x717171FF, 0x979797FF, 0xBDBDBDFF, 0xE3E3E3FF },
            { 0x33A27EFF, 0x39E0A9FF, 0x70FCCEFF, 0xB8FFF0FF },
            { 0x126280FF, 0x0B83B0FF, 0x3DA1C7FF, 0x82BED4FF },
            { 0x316299FF, 0x3681D3FF, 0x6DABEFFF, 0xB3D8FFFF },
            { 0x755F96FF, 0x9B7ACCFF, 0xC8ADF2FF, 0xF9E9FFFF },
            { 0x6F27A4FF, 0x9327E2FF, 0xBD63FFFF, 0xE9B3FFFF },
            { 0x730A8CFF, 0x9B00C1FF, 0xBA37D9FF, 0xD587E8FF },
            { 0x6C336EFF, 0x933D95FF, 0xAF68B1FF, 0xC89DC9FF },
            { 0x858585FF, 0xB1B1B1FF, 0xDEDEDEFF, 0xFFFFFFFF },
            { 0x9C118CFF, 0xD707BFFF, 0xF345DEFF, 0xFF9BF7FF },
            { 0x906B58FF, 0xC78F72FF, 0xE1B29BFF, 0xF2D6C8FF },
            { 0xA87A29FF, 0xEDA82EFF, 0xFAC05AFF, 0xF3D094FF },
            { 0x809553FF, 0xAECD6AFF, 0xCFE996FF, 0xEBFBC9FF },
            { 0x5E9E4EFF, 0x7CDD65FF, 0xA0F18DFF, 0xC7F7BBFF },
            { 0x428547FF, 0x55BA5CFF, 0x76CA7CFF, 0x9CCFA0FF },
            { 0x5D9583FF, 0x76CBB0FF, 0xA9EFD9FF, 0xE4FFFFFF },
            { 0x999999FF, 0xCCCCCCFF, 0xFFFFFFFF, 0xFFFFFFFF },
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0xD0AF83FF, 0xF1D5B0FF, 0xF1D5B0FF, 0xF1D5B0FF },
            { 0xE9AF3CFF, 0xF9C969FF, 0xF9C969FF, 0xF9C969FF },
            { 0x84B762FF, 0xA4CE87FF, 0xA4CE87FF, 0xA4CE87FF },
            { 0x78D0C5FF, 0xAFF8EFFF, 0xAFF8EFFF, 0xAFF8EFFF },
            { 0x009989FF, 0x1DAA9DFF, 0x1DAA9DFF, 0x1DAA9DFF },
            { 0x00BEC4FF, 0x10D6DBFF, 0x10D6DBFF, 0x10D6DBFF },
            { 0x161616FF, 0x1C1C1CFF, 0x1C1C1CFF, 0x1C1C1CFF },
            { 0x0048C7FF, 0x106AD4FF, 0x106AD4FF, 0x106AD4FF },
            { 0x4A7ADBFF, 0x7FA8F8FF, 0x7FA8F8FF, 0x7FA8F8FF },
            { 0x2700E2FF, 0x5229EEFF, 0x5229EEFF, 0x5229EEFF },
            { 0x4375DCFF, 0x79A2F9FF, 0x79A2F9FF, 0x79A2F9FF },
            { 0x7C00EAFF, 0xA11BFDFF, 0xA11BFDFF, 0xA11BFDFF },
            { 0xAC4ED0FF, 0xD486F3FF, 0xD486F3FF, 0xD486F3FF },
            { 0xE98B10FF, 0xEC9E38FF, 0xEC9E38FF, 0xEC9E38FF },
            { 0x303030FF, 0x3D3D3DFF, 0x3D3D3DFF, 0x3D3D3DFF },
            { 0x64D9BEFF, 0x9CFEE7FF, 0x9CFEE7FF, 0x9CFEE7FF },
            { 0x4BCCB2FF, 0x81ECD7FF, 0x81ECD7FF, 0x81ECD7FF },
            { 0x00BABEFF, 0x3AD6D9FF, 0x3AD6D9FF, 0x3AD6D9FF },
            { 0x00C8B8FF, 0x26E0D3FF, 0x26E0D3FF, 0x26E0D3FF },
            { 0x7BC3C4FF, 0xB1EDEDFF, 0xB1EDEDFF, 0xB1EDEDFF },
            { 0x4C70AFFF, 0x7895CAFF, 0x7895CAFF, 0x7895CAFF },
            { 0x5369E0FF, 0x879AFCFF, 0x879AFCFF, 0x879AFCFF },
            { 0x4B4B4BFF, 0x5E5E5EFF, 0x5E5E5EFF, 0x5E5E5EFF },
            { 0x9971C6FF, 0xC5A3EAFF, 0xC5A3EAFF, 0xC5A3EAFF },
            { 0x9A00EAFF, 0xBD15FFFF, 0xBD15FFFF, 0xBD15FFFF },
            { 0xE15D94FF, 0xFB8DBBFF, 0xFB8DBBFF, 0xFB8DBBFF },
            { 0xA5009BFF, 0xB91DB1FF, 0xB91DB1FF, 0xB91DB1FF },
            { 0xB412B0FF, 0xCF48CCFF, 0xCF48CCFF, 0xCF48CCFF },
            { 0xDF4378FF, 0xF16F9BFF, 0xF16F9BFF, 0xF16F9BFF },
            { 0xACBD63FF, 0xC9D88DFF, 0xC9D88DFF, 0xC9D88DFF },
            { 0x656565FF, 0x7F7F7FFF, 0x7F7F7FFF, 0x7F7F7FFF },
            { 0x9DC365FF, 0xBCDD8EFF, 0xBCDD8EFF, 0xBCDD8EFF },
            { 0x56C3AAFF, 0x89E3CEFF, 0x89E3CEFF, 0x89E3CEFF },
            { 0x15A3D2FF, 0x51C7EEFF, 0x51C7EEFF, 0x51C7EEFF },
            { 0x457FD5FF, 0x7AAAF2FF, 0x7AAAF2FF, 0x7AAAF2FF },
            { 0x5476BDFF, 0x839FDAFF, 0x839FDAFF, 0x839FDAFF },
            { 0x7673BEFF, 0xA3A0DEFF, 0xA3A0DEFF, 0xA3A0DEFF },
            { 0x915DD7FF, 0xBF93F8FF, 0xBF93F8FF, 0xBF93F8FF },
            { 0x7D7D7DFF, 0x9C9C9CFF, 0x9C9C9CFF, 0x9C9C9CFF },
            { 0xA51592FF, 0xBB44ACFF, 0xBB44ACFF, 0xBB44ACFF },
            { 0xBB2FCDFF, 0xDF6AEEFF, 0xDF6AEEFF, 0xDF6AEEFF },
            { 0xDD03D8FF, 0xFD47F9FF, 0xFD47F9FF, 0xFD47F9FF },
            { 0x96D066FF, 0xB7E88FFF, 0xB7E88FFF, 0xB7E88FFF },
            { 0x75C38BFF, 0x9FE0B2FF, 0x9FE0B2FF, 0x9FE0B2FF },
            { 0x2CD7C2FF, 0x68F6E5FF, 0x68F6E5FF, 0x68F6E5FF },
            { 0x3DC4A0FF, 0x6FE0C1FF, 0x6FE0C1FF, 0x6FE0C1FF },
            { 0x979797FF, 0xBDBDBDFF, 0xBDBDBDFF, 0xBDBDBDFF },
            { 0x39E0A9FF, 0x70FCCEFF, 0x70FCCEFF, 0x70FCCEFF },
            { 0x0B83B0FF, 0x3DA1C7FF, 0x3DA1C7FF, 0x3DA1C7FF },
            { 0x3681D3FF, 0x6DABEFFF, 0x6DABEFFF, 0x6DABEFFF },
            { 0x9B7ACCFF, 0xC8ADF2FF, 0xC8ADF2FF, 0xC8ADF2FF },
            { 0x9327E2FF, 0xBD63FFFF, 0xBD63FFFF, 0xBD63FFFF },
            { 0x9B00C1FF, 0xBA37D9FF, 0xBA37D9FF, 0xBA37D9FF },
            { 0x933D95FF, 0xAF68B1FF, 0xAF68B1FF, 0xAF68B1FF },
            { 0xB1B1B1FF, 0xDEDEDEFF, 0xDEDEDEFF, 0xDEDEDEFF },
            { 0xD707BFFF, 0xF345DEFF, 0xF345DEFF, 0xF345DEFF },
            { 0xC78F72FF, 0xE1B29BFF, 0xE1B29BFF, 0xE1B29BFF },
            { 0xEDA82EFF, 0xFAC05AFF, 0xFAC05AFF, 0xFAC05AFF },
            { 0xAECD6AFF, 0xCFE996FF, 0xCFE996FF, 0xCFE996FF },
            { 0x7CDD65FF, 0xA0F18DFF, 0xA0F18DFF, 0xA0F18DFF },
            { 0x55BA5CFF, 0x76CA7CFF, 0x76CA7CFF, 0x76CA7CFF },
            { 0x76CBB0FF, 0xA9EFD9FF, 0xA9EFD9FF, 0xA9EFD9FF },
            { 0xCCCCCCFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF },
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0x988264FF, 0xD0AF83FF, 0xF1D5B0FF, 0xFFF9E3FF },
            { 0xA68033FF, 0xE9AF3CFF, 0xF9C969FF, 0xF9DCA2FF },
            { 0x63854CFF, 0x84B762FF, 0xA4CE87FF, 0xC2DCB2FF },
            ...
            { 0x999999FF, 0xCCCCCCFF, 0xFFFFFFFF, 0xFFFFFFFF },
            { 0x00000000, 0x00000000, 0x00000000, 0x00000000 },
            { 0xF1D5B0FF, 0xD0AF83FF, 0xF1D5B0FF, 0xFFF9E3FF },
            { 0xF9C969FF, 0xE9AF3CFF, 0xF9C969FF, 0xF9DCA2FF },
            { 0xA4CE87FF, 0x84B762FF, 0xA4CE87FF, 0xC2DCB2FF },
            { 0xAFF8EFFF, 0x78D0C5FF, 0xAFF8EFFF, 0xF0FFFFFF },
            { 0x1DAA9DFF, 0x009989FF, 0x1DAA9DFF, 0x5FB3ABFF },
            { 0x10D6DBFF, 0x00BEC4FF, 0x10D6DBFF, 0x6EE5E7FF },
            { 0x1C1C1CFF, 0x161616FF, 0x1C1C1CFF, 0x212121FF },
            { 0x106AD4FF, 0x0048C7FF, 0x106AD4FF, 0x5B91D1FF },
            { 0x7FA8F8FF, 0x4A7ADBFF, 0x7FA8F8FF, 0xC3DBFFFF },
            { 0x5229EEFF, 0x2700E2FF, 0x5229EEFF, 0x8B73E9FF },
            { 0x79A2F9FF, 0x4375DCFF, 0x79A2F9FF, 0xBED7FFFF },
            { 0xA11BFDFF, 0x7C00EAFF, 0xA11BFDFF, 0xC979FFFF },
            { 0xD486F3FF, 0xAC4ED0FF, 0xD486F3FF, 0xFDCEFFFF },
            { 0xEC9E38FF, 0xE98B10FF, 0xEC9E38FF, 0xDAAB6DFF },
            { 0x3D3D3DFF, 0x303030FF, 0x3D3D3DFF, 0x494949FF },
            { 0x9CFEE7FF, 0x64D9BEFF, 0x9CFEE7FF, 0xE0FFFFFF },
            { 0x81ECD7FF, 0x4BCCB2FF, 0x81ECD7FF, 0xC5FFF8FF },
            { 0x3AD6D9FF, 0x00BABEFF, 0x3AD6D9FF, 0x8DEAECFF },
            { 0x26E0D3FF, 0x00C8B8FF, 0x26E0D3FF, 0x7DEDE5FF },
            { 0xB1EDEDFF, 0x7BC3C4FF, 0xB1EDEDFF, 0xEFFFFFFF },
            { 0x7895CAFF, 0x4C70AFFF, 0x7895CAFF, 0xADBEDEFF },
            { 0x879AFCFF, 0x5369E0FF, 0x879AFCFF, 0xC8D3FFFF },
            { 0x5E5E5EFF, 0x4B4B4BFF, 0x5E5E5EFF, 0x717171FF },
            { 0xC5A3EAFF, 0x9971C6FF, 0xC5A3EAFF, 0xF2DEFFFF },
            { 0xBD15FFFF, 0x9A00EAFF, 0xBD15FFFF, 0xDD79FFFF },
            { 0xFB8DBBFF, 0xE15D94FF, 0xFB8DBBFF, 0xFFC8E4FF },
            { 0xB91DB1FF, 0xA5009BFF, 0xB91DB1FF, 0xC467BFFF },
            { 0xCF48CCFF, 0xB412B0FF, 0xCF48CCFF, 0xE392E1FF },
            { 0xF16F9BFF, 0xDF4378FF, 0xF16F9BFF, 0xF4A6C1FF },
            { 0xC9D88DFF, 0xACBD63FF, 0xC9D88DFF, 0xE2EBBEFF },
            { 0x7F7F7FFF, 0x656565FF, 0x7F7F7FFF, 0x989898FF },
            { 0xBCDD8EFF, 0x9DC365FF, 0xBCDD8EFF, 0xD9EDBEFF },
            { 0x89E3CEFF, 0x56C3AAFF, 0x89E3CEFF, 0xC6FDF0FF },
            { 0x51C7EEFF, 0x15A3D2FF, 0x51C7EEFF, 0xA2E9FFFF },
            { 0x7AAAF2FF, 0x457FD5FF, 0x7AAAF2FF, 0xBEDBFFFF },
            { 0x839FDAFF, 0x5476BDFF, 0x839FDAFF, 0xBBCCF0FF },
            { 0xA3A0DEFF, 0x7673BEFF, 0xA3A0DEFF, 0xD5D3F8FF },
            { 0xBF93F8FF, 0x915DD7FF, 0xBF93F8FF, 0xF0D6FFFF },
            { 0x9C9C9CFF, 0x7D7D7DFF, 0x9C9C9CFF, 0xBBBBBBFF },
            { 0xBB44ACFF, 0xA51592FF, 0xBB44ACFF, 0xCA83C1FF },
            { 0xDF6AEEFF, 0xBB2FCDFF, 0xDF6AEEFF, 0xFFB9FFFF },
            { 0xFD47F9FF, 0xDD03D8FF, 0xFD47F9FF, 0xFFA6FFFF },
            { 0xB7E88FFF, 0x96D066FF, 0xB7E88FFF, 0xD8F5C0FF },
            { 0x9FE0B2FF, 0x75C38BFF, 0x9FE0B2FF, 0xCEF5DAFF },
            { 0x68F6E5FF, 0x2CD7C2FF, 0x68F6E5FF, 0xB8FFFFFF },
            { 0x6FE0C1FF, 0x3DC4A0FF, 0x6FE0C1FF, 0xAFF3E0FF },
            { 0xBDBDBDFF, 0x979797FF, 0xBDBDBDFF, 0xE3E3E3FF },
            { 0x70FCCEFF, 0x39E0A9FF, 0x70FCCEFF, 0xB8FFF0FF },
            { 0x3DA1C7FF, 0x0B83B0FF, 0x3DA1C7FF, 0x82BED4FF },
            { 0x6DABEFFF, 0x3681D3FF, 0x6DABEFFF, 0xB3D8FFFF },
            { 0xC8ADF2FF, 0x9B7ACCFF, 0xC8ADF2FF, 0xF9E9FFFF },
            { 0xBD63FFFF, 0x9327E2FF, 0xBD63FFFF, 0xE9B3FFFF },
            { 0xBA37D9FF, 0x9B00C1FF, 0xBA37D9FF, 0xD587E8FF },
            { 0xAF68B1FF, 0x933D95FF, 0xAF68B1FF, 0xC89DC9FF },
            { 0xDEDEDEFF, 0xB1B1B1FF, 0xDEDEDEFF, 0xFFFFFFFF },
            { 0xF345DEFF, 0xD707BFFF, 0xF345DEFF, 0xFF9BF7FF },
            { 0xE1B29BFF, 0xC78F72FF, 0xE1B29BFF, 0xF2D6C8FF },
            { 0xFAC05AFF, 0xEDA82EFF, 0xFAC05AFF, 0xF3D094FF },
            { 0xCFE996FF, 0xAECD6AFF, 0xCFE996FF, 0xEBFBC9FF },
            { 0xA0F18DFF, 0x7CDD65FF, 0xA0F18DFF, 0xC7F7BBFF },
            { 0x76CA7CFF, 0x55BA5CFF, 0x76CA7CFF, 0x9CCFA0FF },
            { 0xA9EFD9FF, 0x76CBB0FF, 0xA9EFD9FF, 0xE4FFFFFF },
            { 0xFFFFFFFF, 0xCCCCCCFF, 0xFFFFFFFF, 0xFFFFFFFF },
    };
...
//                            MathUtils.clamp(b, 0, 255) << 8 | 0xFF;
//        }
//        StringBuilder sb = new StringBuilder(1024).append("private static final int[][] CURVEBALL_BONUS_RAMP_VALUES = new int[][] {\n");
//        for (int i = 0; i < 256; i++) {
//            sb.append("{ 0x");
...
//        }
    ...
    public static final Colorizer CurveballBonusColorizer = new Colorizer(new PaletteReducer(Coloring.CURVEBALL64)) {
        private final byte[] primary = {
                37, 2, 43, 48, 18, 28
        }, grays = {
        ...
        public byte brighten(byte voxel) {
            ...
            // denote a structural change to the voxel's makeup, so this uses the first 64 voxel colors to shade both
            // halves, then marks voxels from the second half back to being an unshaded voxel as the last step.
            return (byte) (CURVEBALL_RAMPS[voxel & 0x3F][3] | (voxel & 0xC0));
        }
        ...
        public byte darken(byte voxel) {
            ...
            // denote a structural change to the voxel's makeup, so this uses the first 64 voxel colors to shade both
            // halves, then marks voxels from the second half back to being an unshaded voxel as the last step.
            return (byte) (CURVEBALL_RAMPS[voxel & 0x3F][1] | (voxel & 0xC0));
        }

        @Override
        public int dimmer(int brightness, byte voxel) {
            return CURVEBALL_BONUS_RAMP_VALUES[voxel & 0xFF][
                    brightness <= 0
                            ? 0
                            : brightness >= 3
                            ? 3
