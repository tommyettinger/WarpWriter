...
public abstract class Dimmer implements IDimmer {
     ...
     * <a href="https://i.imgur.com/8dsKzIk.png">View this here</a>.
     */
    ...
    public static final int[][] FLESURRECT_RAMP_VALUES = new int[][]{
            ...
            { 0x484A77FF, 0x2B2E42FF, 0x1F1833FF, 0x1F1833FF },
            { 0x68717AFF, 0x3E3546FF, 0x1F1833FF, 0x1F1833FF },
            { 0x417291FF, 0x414859FF, 0x1F1833FF, 0x1F1833FF },
            { 0x90A1A8FF, 0x68717AFF, 0x484A77FF, 0x414859FF },
            { 0xB6CBCFFF, 0x90A1A8FF, 0x68717AFF, 0x484A77FF },
            { 0xFFFFFFFF, 0xB6CBCFFF, 0x90A1A8FF, 0x4C93ADFF },
            { 0xFFFFFFFF, 0xD3E5EDFF, 0x94D2D4FF, 0x90A1A8FF },
            { 0xFFFFFFFF, 0xFFFFFFFF, 0xD3E5EDFF, 0xB6CBCFFF },
            { 0x826481FF, 0x5C3A41FF, 0x1F1833FF, 0x1F1833FF },
            { 0xC27182FF, 0x826481FF, 0x484A77FF, 0x414859FF },
            ...
            { 0xFF5A4AFF, 0xF53333FF, 0x7A3045FF, 0x1F1833FF },
            { 0xF68181FF, 0xFF5A4AFF, 0xF53333FF, 0xC93038FF },
            { 0xCD683DFF, 0xAE4539FF, 0x7A3045FF, 0x1F1833FF },
            ...
            { 0x8FD3FFFF, 0x30E1B9FF, 0x1EBC73FF, 0x0B8A8FFF },
            { 0xFFFFFFFF, 0x8FF8E2FF, 0x63C2C9FF, 0x4C93ADFF },
            { 0xFFFFFFFF, 0xB8FDFFFF, 0x8FD3FFFF, 0x94D2D4FF },
            { 0xB8FDFFFF, 0x94D2D4FF, 0x63C2C9FF, 0x90A1A8FF },
            { 0x4C93ADFF, 0x0B8A8FFF, 0x264F6EFF, 0x233663FF },
            { 0x94D2D4FF, 0x63C2C9FF, 0x4C93ADFF, 0x417291FF },
            { 0x63C2C9FF, 0x4C93ADFF, 0x264F6EFF, 0x233663FF },
            { 0x63C2C9FF, 0x417291FF, 0x264F6EFF, 0x233663FF },
            { 0xB8FDFFFF, 0x8FD3FFFF, 0x63C2C9FF, 0x4D9BE6FF },
            { 0x417291FF, 0x264F6EFF, 0x1F1833FF, 0x1F1833FF },
            { 0x63C2C9FF, 0x4D9BE6FF, 0x6858F0FF, 0x3F4DD0FF },
            { 0x417291FF, 0x233663FF, 0x1F1833FF, 0x1F1833FF },
            { 0x4D9BE6FF, 0x3F4DD0FF, 0x233663FF, 0x1F1833FF },
            { 0xA884F3FF, 0x6858F0FF, 0x233663FF, 0x1F1833FF },
            { 0x68717AFF, 0x484A77FF, 0x2B2E42FF, 0x1F1833FF },
            { 0xA884F3FF, 0x8657CCFF, 0x3F4DD0FF, 0x484A77FF },
            { 0xF598EAFF, 0xA884F3FF, 0x8657CCFF, 0x3F4DD0FF },
            { 0xA03EB2FF, 0x621075FF, 0x1F1833FF, 0x1F1833FF },
            { 0xF34FE9FF, 0xA03EB2FF, 0x621075FF, 0x1F1833FF },
            { 0xA884F3FF, 0xAB4ED5FF, 0x621075FF, 0x1F1833FF },
            { 0xD3E5EDFF, 0xF598EAFF, 0xF34FE9FF, 0xAB4ED5FF },
            { 0xC27182FF, 0xB53D86FF, 0x7A3045FF, 0x621075FF },
            { 0xF598EAFF, 0xF34FE9FF, 0xAB4ED5FF, 0xA03EB2FF },
            { 0xB53D86FF, 0x7A3045FF, 0x621075FF, 0x1F1833FF },
            { 0xF68181FF, 0xF04F78FF, 0xB53D86FF, 0xC93038FF },
            { 0xF598EAFF, 0xC27182FF, 0xB53D86FF, 0x8A503EFF },
            { 0xF04F78FF, 0xC93038FF, 0x7A3045FF, 0x1F1833FF },
    };
