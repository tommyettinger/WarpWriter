...
public class ShaderUtils {
    ...
    public static final String fragmentShaderWarmMild = 
            "varying vec2 v_texCoords;\n" + 
                    ...
                    "   vec3 ycwcm = u_add + u_mul * vec3(dot(tgt.rgb, vec3(0.375, 0.5, 0.125)), tgt.r - tgt.b, tgt.g - tgt.b);\n" +
                    "   gl_FragColor.rgb = clamp(vec3(dot(ycwcm, vec3(1.0, 0.625, -0.5)), dot(ycwcm, vec3(1.0, -0.375, 0.5)), dot(ycwcm, vec3(1.0, -0.375, -0.5))), 0.0, 1.0);\n" +
                    "   gl_FragColor.a = v_color.a * tgt.a;\n" +
                    "}";
