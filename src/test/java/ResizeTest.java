...
public class ResizeTest extends ApplicationAdapter {
    /**
    ...
    public static void main(String[] arg) {
        ...
        final ResizeTest app = new ResizeTest();
    ...
    public void makeModel() {
        model = new FetchModel(3, 3, 3);
        model.add(ColorFetch.color((byte) 14));
...
//        ).model(16, 16, 16);
    ...
    public void render() {
        ...
        font.draw(batch, StringKit.join(", ", model.sizeX(), model.sizeY(), model.sizeZ()) + " (size of model)", 0, 100);
            ...
            public boolean keyDown(int keycode) {
                switch (keycode) {
                    ...
                    case Input.Keys.T: // try again
                        ...
                        break;
                    case Input.Keys.W:
                        model.setSizeX(model.sizeX() + 1);
                        break;
                    case Input.Keys.S:
                        if (model.sizeX() > 1) model.setSizeX(model.sizeX() - 1);
                        break;
                    case Input.Keys.A:
                        if (model.sizeY() > 1) model.setSizeY(model.sizeY() - 1);
                        break;
                    case Input.Keys.D:
                        model.setSizeY(model.sizeY() + 1);
                        break;
                    case Input.Keys.SPACE:
                        model.setSizeZ(model.sizeZ() + 1);
                        break;
                    case Input.Keys.C:
                        if (model.sizeZ() > 1) model.setSizeZ(model.sizeZ() - 1);
                        break;
